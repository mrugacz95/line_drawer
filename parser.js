        ...
        function peg$parse(input, options) {
            ...
            var peg$FAILED = {},
                ...
                peg$consts = [
                    ...
                    "ENDFOR",
                    peg$literalExpectation("ENDFOR", false),
                    function(loopnum, exp) {
                    ...
                    "FW",
                    peg$literalExpectation("FW", false),
                    function(steps) {
                        return function(){
                    ...
                    "BW",
                    peg$literalExpectation("BW", false),
                    function(steps) {
                        return function(){
                            parseInt(steps);
                            var move = new Vector(steps + block_size, 0);
                ...
                peg$bytecode = [
                    ...
                    peg$decode("%$;\"0#*;\"&/' 8!: !! )"),
                    peg$decode(";(./ &;#.) &;$.# &;%"),
                    peg$decode("%;'/{#2!\"\"6!7\"/l$;&/c$;'/Z$$;\"0#*;\"&/J$;'/A$2#\"\"6#7$/2$;'/)$8(:%(\"%#)(('#(''#(&'#(%'#($'#(#'#(\"'#&'#"),
                    peg$decode("%;'/I#2&\"\"6&7'/:$;&/1$;'/($8$:($!!)($'#(#'#(\"'#&'#.S &%;'/I#2)\"\"6)7*/:$;&/1$;'/($8$:+$!!)($'#(#'#(\"'#&'#"),
                    peg$decode("%;'/I#2,\"\"6,7-/:$;&/1$;'/($8$:.$!!)($'#(#'#(\"'#&'#.S &%;'/I#2/\"\"6/70/:$;&/1$;'/($8$:1$!!)($'#(#'#(\"'#&'#"),
                    peg$decode("<%;'/I#$43\"\"5!74/,#0)*43\"\"5!74&&&#/'$8\":5\" )(\"'#&'#=.\" 72"),
                    peg$decode("<$47\"\"5!780)*47\"\"5!78&=.\" 76"),
                    peg$decode("%;'/a#29\"\"697:/R$$4;\"\"5!7<0)*4;\"\"5!7<&/6$2=\"\"6=7>/'$8$:?$ )($'#(#'#(\"'#&'#")
                ],
